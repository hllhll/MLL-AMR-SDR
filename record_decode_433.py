...
class record_decode_433(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\hll\\miltel_no_fhss\\final_decode_server\\MLL-AMR-SDR\\tst_samples\\102017167_bad\\all.complex', False, 0, 0)
